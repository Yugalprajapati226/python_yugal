...
REPLICATE_API_TOKEN = st.secrets["REPLICATE_API_TOKEN = r8_AuQXa8S0Fry9PD3thoCHvyuHhngwyd84caPVS"]
...
def configure_sidebar() -> None:
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            𝕏 → [@Kundan bharti](https://x.com/KundanB15666936)

            LinkedIn → [Kundan Bharti](www.linkedin.com/in/kundan-bharti-9604a7213)
